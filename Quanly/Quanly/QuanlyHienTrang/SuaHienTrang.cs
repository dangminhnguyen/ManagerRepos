...
namespace Quanly
{
    public partial class SuaHienTrang : Form
    {
        ...
        public SuaHienTrang(int key, int keyseri)
        {
            InitializeComponent();
        ...
        public void getthongtin(int pk)
        {
            ...
            if(r.vitri != null && r.vitri != "")
            {
                VitriHandler vth = new VitriHandler();
                
                
                Vitri vt = vth.laythongtin(r.vitri, "");
                vitricb.SelectedValue = vt.ma;
            }
            else
            {
                MessageBox.Show("null me roi");
            }
        ...
        public void getkh(int key)
        {
            ...
            {
                khachhangCB.SelectedValue = r.khachhang;
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string vitri = ((KeyValuePair<string, string>)vitricb.SelectedItem).Key;

            SeriHandler s = new SeriHandler();

            s.suaKH(khachhang, this.keyseri);

            //Them vao lich su
            LichSuHandler ls = new LichSuHandler();
            int keyseri=ls.sua(pk, hientrang, richTextBox2.Text, makysu, dateTimePicker1.Value, richTextBox1.Text,khachhang, vitri);
