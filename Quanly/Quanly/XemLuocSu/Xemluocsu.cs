...
namespace Quanly
{
    public partial class Xemluocsu : Form
    {
        ...
        private void getKhachhangCB(int x)
        {
            ...
            if (list.Count == 0)
            {
                MessageBox.Show("Rat tiet! hien khong co lich su, vui long cap nhat lich su may");
            }
            else
            {
                ...
                foreach (Record r in list)
                {
                    if (r.khachhang != null && r.khachhang != "")
                    {
                        ...
                        if (!combosource.ContainsKey(k.ma))
                        {
                            combosource.Add(k.ma, k.ten);
                        }
                    }
                }
            }
        ...
        public void tracuu()
        {
            ...
            if (r1.vitri != null && r1.vitri != "")
            {
                VitriHandler vthd = new VitriHandler();
                Vitri vt = vthd.laythongtin(r1.vitri, "");
                vitritxtb.Text = vt.ten;
            ...
            foreach (Record r in list)
            {
                ...
                if (r.khachhang != null)
                {
                    ...
                    khstr = khh.laythongtin(r.khachhang, "");
                    dataGridView1.Rows.Add(r.pk, r.hientrang, r.khacphuc, k.ten,
                    r.thoigian.ToString("dd/MM/yyyy hh:mm:ss"), khstr.ten,r.vitri, r.ghichu);
                }
                else
                {
                    dataGridView1.Rows.Add(r.pk, r.hientrang, r.khacphuc, k.ten,
                    r.thoigian.ToString("dd/MM/yyyy hh:mm:ss"), r.khachhang,r.vitri, r.ghichu);
                }
        ...
        private void dataGridView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            foreach (DataGridViewRow row in dataGridView1.SelectedRows)
            {
                ...
                SuaHienTrang frm2 = new SuaHienTrang(x, pk);
        ...
        private void KhachhangCB_DropDown(object sender, EventArgs e)
        {
            getKhachhangCB(pk);
        }
    }
