    ...
    public partial class NhapDuLieuHangLoat : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            for (int i = 1; i <= rowCount; i++)
            {
                ...
                DateTime? checkdate = kiemTraNgay(date);
                DateTime mydate;
                if (checkdate == null)
                {
        ...
        public DateTime? kiemTraNgay(String date) 
        {
            ...
            try
            {
                ...
                int years = Int32.Parse(date.Substring(4, 4));
                ...
                mydate = new DateTime(years, month, day, hour, minute, second);
            }
            catch (Exception ev)
            {
                mydate = null;
